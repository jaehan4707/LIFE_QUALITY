...
class CardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        models.add(Model(R.drawable.nutrition, "영양관리", "나이가 들수록 떨어지는 입맛! 건강한 식생활 함께 지켜봐요"))
        models.add(Model(R.drawable.emotion, "우울관리", "혹시 내가 노인 우울증? 예방과 치료방법 살펴봐요"))
        models.add(Model(R.drawable.mouth, "구강관리", "자신감 있는 미소를 위해! 깨끗하게 관리하고 밝게 웃어봐요^^"))
        models.add(Model(R.drawable.excercise, "운동 건강관리", "자신에게 맞는 올바른 운동 실천, 안전하게 건강 챙겨봐요!"))
        models.add(Model(R.drawable.yosil, "요실금 관리", "말 못 할 고민, 적절한 관리법 배워봐요!"))
